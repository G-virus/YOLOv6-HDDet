...
from yolov6.models.yolo_R import *
from yolov6.models.effidehead_R import Detect
...
#NOTE 由于旋转框NMS原生的TensorRT并没有plugin 作为映射

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', type=str, default='./yolov6s.pt', help='weights path')
    parser.add_argument('--img-size', nargs='+', type=int, default=[800, 800], help='image size, the order is: height width')  # height, width
