...
def xml2txt(xml_path: Path):
    ...
    store_path = Path(r"/Volumes/file_transit/HESC2016/Train/info_train/")
    ...
    train_list = []
    train_labels_list = []
    train_list_path = Path(r"/Volumes/file_transit/HESC2016/Train/train.txt")
    ...
    val_list = []
    val_labels_list = []
    val_list_path = Path(r"/Volumes/file_transit/HESC2016/Train/val.txt")
...
if __name__ == "__main__":
    import cv2
    #
    # #xml2txt(Path(r'/Volumes/file_transit/HESC2016/Train/Annotations'))
    # xml_path = Path(r"/Volumes/file_transit/HESC2016/Test/Annotations")
    # txt_path = Path(r"/Volumes/file_transit/HESC2016/Test/labels/")
    # img_prefix_path = Path(r"/Volumes/file_transit/HESC2016/Test/images")
    #
    # for xml_path in xml_path.glob("*.xml"):
    #     img_path = img_prefix_path / xml_path.with_suffix(".bmp").name
    #     # print(img_path)
    ...
    img_path = Path(r"/Volumes/file_transit/HESC2016/images/train/100000622.bmp")
    img = cv2.imread(str(img_path))
    h, w, _ = img.shape
    xml_path = Path(r"/Volumes/file_transit/HESC2016/Train/Annotations/100000622.xml")
