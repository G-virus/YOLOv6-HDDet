...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--source', type=str, default='/home/qd1205/PycharmProjects/learn_torch/yolo/datasets/car/images/train', help='the source path, e.g. image-file/dir.')
    ...
    parser.add_argument('--yaml', type=str, default='./data/CAR.yaml', help='data yaml file.')
    parser.add_argument('--img-size', nargs='+', type=int, default=[800, 800], help='the image-size(h,w) in inference size.')
    ...
    parser.add_argument('--save-dir', type=str, default="runs/infer/", help='directory to save predictions in. See --save-txt.')
