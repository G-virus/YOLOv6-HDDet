...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--data-path", default="./data/DOTA.yaml", type=str, help="path of dataset")
    parser.add_argument(
        "--conf-file", default="./configs/ohd/yolov6n_finetune-ohd.py", type=str, help="experiments description file"
    )
